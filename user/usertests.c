...
// that read user memory with mycopyin?
void
mycopyin(char *s)
{
...
// what if you pass ridiculous pointers to system calls
// that write user memory with mycopyout?
void
mycopyout(char *s)
{
  uint64 addrs[] = { 0x80000000LL, 0xffffffffffffffff };
...
// still mycopyin() from addresses in the last page?
void
sbrklast(char *s)
{
  uint64 top = (uint64) sbrk(0);
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    {mycopyin, "mycopyin"},
    {mycopyout, "mycopyout"},
    {mycopyinstr1, "mycopyinstr1"},
    {mycopyinstr2, "mycopyinstr2"},
    {mycopyinstr3, "mycopyinstr3"},
    {rwsbrk, "rwsbrk" },
    {truncate1, "truncate1"},
    {truncate2, "truncate2"},
    {truncate3, "truncate3"},
